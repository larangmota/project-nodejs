...
<p align="center">
  <img alt="Product art design shop" src="public/images/pdart.JPG" width="100%">
</p>
...
Este projeto foi uma oportunidade para aplicar os conhecimentos adquiridos ao longo do curso, tanto no front-end quanto no back-end, utilizando tecnologias como HTML, CSS, Handlebars, JavaScript, Node.js e bancos de dados. O foco principal foi garantir uma navegação fluida e intuitiva, além de implementar funcionalidades essenciais para um e-commerce moderno.
